...
silver_df = (bronze_df
    ...
    .withColumn("_silver_customer_processed_at", current_timestamp()) # Audit column
...
spark.sql("OPTIMIZE misgauravcatalog.silverdb.silver_customer_data ZORDER BY customer_id")
